...
//--------------- Alert-Screen -----------------------------------------
        ...
        //-------------- LISTA ------------------------------------------------
        list = new List("Hänvisning", Choice.EXCLUSIVE); // skapar en lista

        sendCommand = new Command("Hänvisa", Command.OK, 3);
        cancelCommand = new Command("Bakåt", Command.BACK, 4);
        ...
        list.append("Röstbrevlåda", null); // attribut
        list.append("Ta bort hänvisning", null); // attribut
        list.append("Nattkoppling", null); // attribut
        list.append("In/Urlogg Mobil", null); // attribut
        ...
        dialTextBox = new TextBox("MexB ver 1.0", "", 30,
                                  TextField.PHONENUMBER);
